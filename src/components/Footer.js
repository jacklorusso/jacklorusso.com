...
const Footer = () => (
  <footer>
    <div className="flex justify-between items-center max-w-xxxl mx-auto p-4 md:p-8 text-sm">
      <p className="text-gray-darkest text-xs">© Jack Lo Russo, 2018 </p>
      <div>
        <a
          href="https://github.com/lol-russo"
          className="no-underline text-grey mr-4"
        >
          <svg
